...
func (ai *AI) GenerateActionCard(actionBlock *domain.ActionBlock) (*string, error) {
    ...
    - The ui tools list should only contain items from this list NEVER add any other ui tools. list : ["box_breathing", "daily_journal", "grounding", "tracker"].
...
`, content))
	...
	validKeys := []string{
		...
		"Digital safety anxiety", "Activist burnout", "Surveillance fear",
	}
