...
const Sidebar: React.FC<SidebarProps> = ({ isCollapsed, onToggle }) => {
  ...
  return (
    <div
      className={`bg-[#f6f6f6] dark:bg-gray-800 shadow-2xl text-blue h-screen flex flex-col border-2 border-gray-200 dark:border-gray-700 transition-all duration-300 ${
